...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SMARTCONTRACT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SMARTCONTRACT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SMARTCONTRACT actions', async () => {
      const arg = { id: 22446 };
    ...
    it('dispatches UPDATE_SMARTCONTRACT actions', async () => {
      const arg = { id: 22446 };
    ...
    it('dispatches PARTIAL_UPDATE_SMARTCONTRACT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SMARTCONTRACT actions', async () => {
      const arg = 42666;
